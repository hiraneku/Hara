...
import { docEl, kunciKeyboard } from './editor/caret.js?v=20260909082613';
import { refresh } from './editor/cleanup.js?v=20260909082613';
import { snap } from './editor/history.js?v=20260909082613';
import { modeBacaBerlaku } from './mode-baca.js?v=20260909082613';
...
function bukaPilihGanti() {
  ...
  inp.onchange = () => {
    ...
    inp.remove();
    if (!f) return;
    import('./editor/image.js?v=20260909082613')
      .then(async m => {
