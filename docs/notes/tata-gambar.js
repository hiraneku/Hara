...
import { docEl, kunciKeyboard } from './editor/caret.js?v=20260909084636';
import { refresh } from './editor/cleanup.js?v=20260909084636';
import { snap } from './editor/history.js?v=20260909084636';
import { modeBacaBerlaku } from './mode-baca.js?v=20260909084636';
...
function bukaPilihGanti() {
  ...
  inp.onchange = () => {
    ...
    inp.remove();
    if (!f) return;
    import('./editor/image.js?v=20260909084636')
      .then(async m => {
