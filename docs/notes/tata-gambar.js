...
import { docEl, kunciKeyboard } from './editor/caret.js?v=20260909102312';
import { refresh } from './editor/cleanup.js?v=20260909102312';
import { snap } from './editor/history.js?v=20260909102312';
import { modeBacaBerlaku } from './mode-baca.js?v=20260909102312';
...
function bukaPilihGanti() {
  ...
  inp.onchange = () => {
    ...
    inp.remove();
    if (!f) return;
    import('./editor/image.js?v=20260909102312')
      .then(async m => {
