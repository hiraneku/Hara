...
import { docEl, kunciKeyboard } from './editor/caret.js?v=20260918132843';
import { refresh } from './editor/cleanup.js?v=20260918132843';
import { snap } from './editor/history.js?v=20260918132843';
import { modeBacaBerlaku } from './mode-baca.js?v=20260918132843';
...
function bukaPilihGanti() {
  ...
  inp.onchange = () => {
    ...
    inp.remove();
    if (!f) return;
    import('./editor/image.js?v=20260918132843')
      .then(async m => {
