...
import { docEl, kunciKeyboard } from './editor/caret.js?v=20260915025704';
import { refresh } from './editor/cleanup.js?v=20260915025704';
import { snap } from './editor/history.js?v=20260915025704';
import { modeBacaBerlaku } from './mode-baca.js?v=20260915025704';
...
function bukaPilihGanti() {
  ...
  inp.onchange = () => {
    ...
    inp.remove();
    if (!f) return;
    import('./editor/image.js?v=20260915025704')
      .then(async m => {
