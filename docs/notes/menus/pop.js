...
import { docEl, ensureCaret, kunciKeyboard } from '../editor/caret.js?v=20260907005847';
import { setBlock, insertHr, insertTanggal } from '../editor/blocks.js?v=20260907005847';
import { insertInline } from './insert.js?v=20260907005847';
import { focusKeep } from '../bar/render.js?v=20260907005847';
import { applyLink } from './link.js?v=20260907005847';
import { setFont } from '../editor/font.js?v=20260907005847';
import { setCallout } from '../editor/blocks.js?v=20260907005847';
import { snap as snapFont } from '../editor/history.js?v=20260907005847';
import { getar } from '../bar/prefs.js?v=20260907005847';
...
export function bindPop() {
  ...
  p.addEventListener('click', e => {
    ...
    if (inf) {
      getar();
      import('../bar/render.js?v=20260907005847').then(({ helpPanel, gantiIsiPop }) => {
    ...
    if (bk) {
      getar();
      import('../bar/render.js?v=20260907005847').then(({ kembaliKeMenu }) => kembaliKeMenu());
      return;
    }
    ...
    if (gm) {
      ...
      kunciKeyboard();
      closeAll();
      import('../bar/render.js?v=20260907005847').then(({ jalankan }) => jalankan(gm.dataset.m, gm));
      return;
    }
