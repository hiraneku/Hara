...
import { BAR, GROUPS } from './config.js?v=20260918132843';
import { ACTIONS, TANPA_SNAP } from './actions.js?v=20260918132843';
import { docEl, ensureCaret, curBlock, kunciKeyboard } from '../editor/caret.js?v=20260918132843';
import { openPop, closeAll, setPopIsi } from '../menus/pop.js?v=20260918132843';
import { slashMenu } from '../menus/slash.js?v=20260918132843';
import { wlMenu }    from '../menus/wikilink.js?v=20260918132843';
import { tagMenu }   from '../menus/tag.js?v=20260918132843';
import { linkMenu }  from '../menus/link.js?v=20260918132843';
import { fontMenu } from '../menus/font.js?v=20260918132843';
import { warnaMenu } from '../menus/warna.js?v=20260918132843';
import { calloutMenu } from '../menus/callout.js?v=20260918132843';
import { snap } from '../editor/history.js?v=20260918132843';
import { ketikaFontMuat, fontMasihMuat } from '../editor/font.js?v=20260918132843';
import { tersembunyi, getar } from './prefs.js?v=20260918132843';
import { HELP, HELP_GRUP } from './help.js?v=20260918132843';
...
function jalankan(m, btn) {
  ...
  if (m === 'tagwarna') { import('../tagwarna.js?v=20260918132843').then(({panelTag}) => panelTag(btn)); return; }
  if (m === 'gal') {
    const mb = document.querySelector('.mb-g.open');
    import('../galeri.js?v=20260918132843').then(({bukaGaleri}) => bukaGaleri(mb || document.querySelector('.ed-doc')));
    return;
  }
