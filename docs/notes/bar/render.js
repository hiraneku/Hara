...
import { BAR, GROUPS } from './config.js?v=20260909054938';
import { ACTIONS, TANPA_SNAP } from './actions.js?v=20260909054938';
import { docEl, ensureCaret, curBlock, kunciKeyboard } from '../editor/caret.js?v=20260909054938';
import { openPop, closeAll, setPopIsi } from '../menus/pop.js?v=20260909054938';
import { slashMenu } from '../menus/slash.js?v=20260909054938';
import { wlMenu }    from '../menus/wikilink.js?v=20260909054938';
import { tagMenu }   from '../menus/tag.js?v=20260909054938';
import { linkMenu }  from '../menus/link.js?v=20260909054938';
import { fontMenu } from '../menus/font.js?v=20260909054938';
import { warnaMenu } from '../menus/warna.js?v=20260909054938';
import { calloutMenu } from '../menus/callout.js?v=20260909054938';
import { snap } from '../editor/history.js?v=20260909054938';
import { ketikaFontMuat, fontMasihMuat } from '../editor/font.js?v=20260909054938';
import { tersembunyi, getar } from './prefs.js?v=20260909054938';
import { HELP, HELP_GRUP } from './help.js?v=20260909054938';
...
function jalankan(m, btn) {
  ...
  if (m === 'tagwarna') { import('../tagwarna.js?v=20260909054938').then(({panelTag}) => panelTag(btn)); return; }
  if (m === 'gal') {
    const mb = document.querySelector('.mb-g.open');
    import('../galeri.js?v=20260909054938').then(({bukaGaleri}) => bukaGaleri(mb || document.querySelector('.ed-doc')));
    return;
  }
