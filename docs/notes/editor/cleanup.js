...
import { docEl, sel, curBlock } from './caret.js?v=20260907035221';
import { renumber } from './blocks.js?v=20260907035221';
import { MARKSEL, markActive, pending } from './marks.js?v=20260907035221';
import { state, save } from '../../core/store.js?v=20260907035221';
import { findNote } from '../model.js?v=20260907035221';
import { domToBlocks, touch, pastikanBlockId } from '../note-model.js?v=20260907035221';
import { tandaiBerubah, flush } from '../../core/autosave.js?v=20260907035221';
import { cur } from '../../core/router.js?v=20260907035221';
import { canUndo, canRedo, record, isReplaying } from './history.js?v=20260907035221';
import { GROUPS } from '../bar/config.js?v=20260907035221';
