...
import { docEl, sel, curBlock } from './caret.js?v=20260908230043';
import { renumber, pastikanKolomAkhir } from './blocks.js?v=20260908230043';
import { seimbangkanGagangGambar } from '../tata-gambar.js?v=20260908230043';
import { MARKSEL, markActive, pending } from './marks.js?v=20260908230043';
import { state, save } from '../../core/store.js?v=20260908230043';
import { findNote } from '../model.js?v=20260908230043';
import { domToBlocks, touch, pastikanBlockId, pastikanGandel } from '../note-model.js?v=20260908230043';
import { sinkronTag } from '../tags.js?v=20260908230043';
import { tandaiTautan } from '../wikilink.js?v=20260908230043';
import { tandaiBerubah, flush } from '../../core/autosave.js?v=20260908230043';
import { cur } from '../../core/router.js?v=20260908230043';
import { canUndo, canRedo, record, isReplaying } from './history.js?v=20260908230043';
import { GROUPS } from '../bar/config.js?v=20260908230043';
import { warnaSekarang, warnaPending } from './warna.js?v=20260908230043';
import { sorotSekarang, sorotPending } from './sorotan.js?v=20260908230043';
